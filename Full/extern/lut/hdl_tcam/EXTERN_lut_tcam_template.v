...
#(
    ...
    parameter INPUT_WIDTH = 2*KEY_WIDTH + ADDRESS_WIDTH + VALUE_WIDTH + OP_WIDTH + 1,
...
/* Tuple format for input:
        [2*KEY_WIDTH+ADDRESS_WIDTH+VALUE_WIDTH+OP_WIDTH    : 2*KEY_WIDTH+ADDRESS_WIDTH+VALUE_WIDTH+OP_WIDTH  ] : statefulValid_in
        [2*KEY_WIDTH+ADDRESS_WIDTH+VALUE_WIDTH+OP_WIDTH-1  : KEY_WIDTH+ADDRESS_WIDTH+VALUE_WIDTH+OP_WIDTH    ] : key_in 
        [KEY_WIDTH+ADDRESS_WIDTH+VALUE_WIDTH+OP_WIDTH-1    : ADDRESS_WIDTH+VALUE_WIDTH+OP_WIDTH              ] : mask_in
...
*/
    ...
    (
       // Outputs
       .dout                           ({statefulValid_fifo, key_fifo, mask_fifo, address_fifo, newValue_fifo, opCode_fifo}),
       .full                           (full_fifo),
       .nearly_full                    (),
       .prog_full                      (),
       .empty                          (empty_fifo),
